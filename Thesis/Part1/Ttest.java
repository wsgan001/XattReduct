...
public class Ttest {
	...
	private static String getHead(boolean isPavl,int type, double[] p, String [] keys) {
		...
		// TODO Auto-generated method stub
		String str = "";
		String alpha = doubleFormat("0.00", p[0]);
		String ensize = Integer.toString((int)p[1]);
		String per = doubleFormat("0.00", p[2]);
		String title = "比较"+(type==0?"AC":"NMI")+":参数为Alpha="+alpha+" Ensemble size="+ensize+" Labeled percent="+per;
		String label = "";
